      ...
      <Fragment>
        <div>
          ...
          <section className="portfolioicon-section">
            <div className="polaroid">
              ...
              <div className="container">
                ...
                <ul>
                  ...
                  <li>Uses pagination, filtering, and sorting of information</li>
                  <li>Practice raising and handling events</li>
                  <li>Uses JSON Web Tokens for authentication and authorization</li>
            ...
            <hr />
            <div className="polaroid">
              <img src={ShoppingBrain} alt="Shopping Brain" className="polaroid-image" />
              <div className="container">
                ...
                <ul>
                  ...
                  <li>Protected manipulation of information depending users's authentication</li>
                  <li>Uses JavaScript's mapping method dynamically display the shopping list</li>
                </ul>
              </div>
            </div>
            <hr />
            <div className="polaroid">
              ...
              <div className="container">
                ...
                <ul>
                  <li>Demonstrates full CRUD using on an Express Server connected to MongoDB</li>
            ...
            <div className="polaroid">
              ...
              <div className="container">
                ...
                <ul>
                  ...
                  <li>Passing data from parent to child components</li>
                  <li>Full login/password functionality (reset, forgot, change)</li>
                  <li>Uses context to pass data through the component tree</li>
                  <li>Timestamp functionality for commenting on the oldest profiles</li>
                </ul>
              </div>
            </div>
            <hr />
            <div className="polaroid">
              ...
              <div className="container">
                ...
                <p> React </p>
                <ul>
                  <li>Passing data from parent component to child components</li>
                  <li>Dynamically utilizes React's state to build arrays of names</li>
                  <li>Uses JavaScript's Math.Random() function to randomly pick a name</li>
                  <li>Utilizes the raising and handling events in the components</li>
                </ul>
              </div>
            </div>
